...
<div class="vs-column half">
	...
	<div>
		...
		<div id="continent-search-load" style="max-width: 150px;">&nbsp;</div>
	</div>
...
<div class="vs-column half fit">
	...
	<div class="line" style="margin-bottom:0"></div>
	<div>
		<div id="country-search-wrap" style="display: block;">{include file="tpl_frontend/tpl_affiliate/tpl_maps_countries.tpl"}</div>
...
gapi.analytics.ready(function() {ldelim}
	...
	$("#country_selector").on("change", function() {ldelim}
		...
		var u = '{$main_url}/{href_entry key="affiliate"}?{if $smarty.get.a ne ""}a={$smarty.get.a|sanitize}{elseif $smarty.get.g ne ""}g={$smarty.get.g|sanitize}{/if}&t='+$('.view-mode-type.active').attr('rel-t') + '&f=' + $('.content-filters li a.active').attr('rel-t') + '&c=' + countryData.iso2{if $smarty.get.r ne ""}+'&r={$smarty.get.r|sanitize}'{/if};
