	...
	<div class="wdmax entry-list" id="ct-wrapper">
	    <div class="section-top-bar{if $smarty.get.do eq "add"}-add{else} vs-maskx{/if} left-float top-bottom-padding">
    	    ...
    	    <div class="vs-mask">{generate_html type="sub_entry" bullet_id="ct-bullet1" entry_id="ct-entry-details1" bb=1}</div>
	...
	<script type="text/javascript">{include file="f_scripts/be/js/tip.js"}</script>
