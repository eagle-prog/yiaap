...
#lb-wrapper h3.content-title{ldelim}width: 95%;font-size: 14px;{rdelim}
...
.dark #lb-wrapper {ldelim}background-color: #131313;{rdelim}
...
#v-tabs .responsive-accordion-panel, #lb-wrapper .responsive-accordion-panel{ldelim}display: block;{rdelim}
...
<script>
{if $smarty.get.rg eq ""}
	{include file="tpl_backend/tpl_subscriber/tpl_subscribers_js.tpl"}
{else}
	{include file="tpl_backend/tpl_subscriber/tpl_subscribersrg_js.tpl"}
{/if}
</script>