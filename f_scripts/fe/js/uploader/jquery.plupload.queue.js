...
function doinput(type, id, filename, value) {
	if (typeof($("#"+id+"-form-c").html()) == 'undefined') {
		f = '<form id="' + id + '-form-c" method="post" action="" class="entry-form-class c-entry-form-edit" style="display: none;"><input type="hidden" name="ekey[]" value="'+id+'"><input type="hidden" name="efile[]" value="'+filename+'"></form>';
...
(function($, o) {
	...
	$.fn.pluploadQueue = function(settings) {
		...
		var categ = '<div class="selector no-entry-form-class' + categ_class + '">' + cat + '</div>';
						...
						fileList.append(
							'<li id="' + file.id + '">' +
								...
								inputHTML +
							'</li>' +
							'<li id="' + file.id + '-edit" class="pl-entry-edit" style="display: none;">' +
