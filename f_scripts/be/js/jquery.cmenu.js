(function($)
{
	...
	{
	    $(".hov-class").mouseover(function () { $(this).css('background-color', '#EAEAEA'); }).mouseout(function () { $(this).css('background-color', '#FFFFFF'); });
		var shown = false;
		...
		var showDIV = function(div, delay)
		{
			...
			if ( !div.isVisible )
			{
				div.timer = setTimeout(function()
				{
					...
					{
						$(div).css('left', div.parentNode.offsetWidth - liOffset + 2);
					}
					//show it
					if($("#entry-action-buttons > li").hasClass("main hover")) {
					    $("#entry-actions").removeClass("form-button").addClass("form-button-active");
					}
					if($("#playlist-action-buttons > li").hasClass("main hover")) {
					    $("#playlist-actions").removeClass("form-button").addClass("form-button-active");
					}
					if($("#nav-action-buttons > li").hasClass("main hover")) {
					    $("#nav-actions").removeClass("topnav-button").addClass("topnav-button-active");
					}
					if($("#nav-upload-buttons > li").hasClass("main hover")) {
					    $("#upload-actions").removeClass("upnav-button").addClass("upnav-button-active");
					}
					if($("#nav-be-upload-buttons > li").hasClass("main hover")) {
					    $("#upload-actions").removeClass("topnav-button").addClass("topnav-button-active");
					}
					if($("#nav-browse-buttons > li").hasClass("main hover")) {
					    $("#browse-actions").removeClass("upnav-button").addClass("upnav-button-active");
					}
					if($("#view-add-actions > li").hasClass("main hover")) {
					    $("#add-actions").removeClass("topnav-button").addClass("topnav-button-active");
					}
					if($("#file-flag-reasons > li").hasClass("main hover")) {
					    $("#file-flag-list").removeClass("topnav-button").addClass("topnav-button-active");
					}
					if($("#file-sort-actions > li").hasClass("main hover")) {
					    $("#sort-file-type").removeClass("sort-button").addClass("sort-button-active");
					}
					if($("#file-type-actions > li").hasClass("main hover")) {
					    $("#sort-file-type").removeClass("upnav-button").addClass("upnav-button-active");
					}
					if($("#file-time-actions > li").hasClass("main hover")) {
					    $("#sort-file-time").removeClass("upnav-button").addClass("upnav-button-active");
					}
					if($("#nav-language > li").hasClass("main hover")) {
					    $("#change-lang").removeClass("upnav-button").addClass("upnav-button-active");
					}
		...
		var hoverIn = function(li, delay)
		{
			...
			$(li.parentNode.getElementsByTagName('DIV')).each(function(){
				...
				{
					if($("#entry-action-buttons > li").hasClass("main hover")) {
//					    $("#entry-actions").removeClass("form-button-active").addClass("form-button");
					}
					if($("#nav-action-buttons > li").hasClass("main hover")) {
					    $("#nav-actions").removeClass("topnav-button-active").addClass("topnav-button");
					}
					if($("#nav-upload-buttons > li").hasClass("main hover")) {
					    $("#upload-actions").removeClass("upnav-button-active").addClass("upnav-button");
					}
					if($("#nav-be-upload-buttons > li").hasClass("main hover")) {
					    $("#upload-actions").removeClass("topnav-button-active").addClass("topnav-button");
					}
					if($("#nav-browse-buttons > li").hasClass("main hover")) {
					    $("#browse-actions").removeClass("upnav-button-active").addClass("upnav-button");
					}
					if($("#file-sort-actions > li").hasClass("main hover")) {
                                            $("#sort-file-type").removeClass("sort-button-active").addClass("sort-button");
                                        }
					if($("#file-type-actions > li").hasClass("main hover")) {
                                            $("#sort-file-type").removeClass("upnav-button-active").addClass("upnav-button");
                                        }
					if($("#file-time-actions > li").hasClass("main hover")) {
					    $("#sort-file-time").removeClass("upnav-button-active").addClass("upnav-button-active");
                                        }
					if($("#nav-language > li").hasClass("main hover")) {
                                            $("#change-lang").removeClass("upnav-button-active").addClass("upnav-button");
                                        }
					hideDIV(this, delay);
		...
		var clean = function()
		{
			...
			$('ul.clickMenu div.outerbox').each(function(){
				...
				if ( this.isVisible )
				{
					...
					if($("#playlist-action-buttons > li").hasClass("main hover")) {
					    $("#playlist-actions").removeClass("form-button-active").addClass("form-button");
					}
					if($("#nav-action-buttons > li").hasClass("main hover")) {
					    $("#nav-actions").removeClass("topnav-button-active").addClass("topnav-button");
					}
					...
					if($("#view-add-actions > li").hasClass("main hover")) {
					    $("#add-actions").removeClass("topnav-button-active").addClass("");
					}
					if($("#file-flag-reasons > li").hasClass("main hover")) {
					    $("#file-flag-list").removeClass("topnav-button-active").addClass("");
					}
					if($("#file-sort-actions > li").hasClass("main hover")) {
                                            $("#sort-file-type").removeClass("sort-button-active").addClass("sort-button");
                                        }
					...
					if($("#file-time-actions > li").hasClass("main hover")) {
                                            $("#sort-file-time").removeClass("upnav-button-active").addClass("upnav-button");
                                        }
					if($("#nav-language > li").hasClass("main hover")) {
                                            $("#change-lang").removeClass("upnav-button-active").addClass("upnav-button");
                                        }
