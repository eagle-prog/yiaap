...
function thisWeek(_sel) {
    ...
    if (_sel == '' || _sel.indexOf("e") >= 0)
    	ds.push(_e);

    _t = {
        label: "Tokens Purchased",
        fillColor: "rgba(101, 133, 187,0.5)",
        strokeColor: "rgba(101, 133, 187,1)",
        pointColor: "rgba(101, 133, 187,1)",
        pointStrokeColor: "#fff",
        pointHighlightFill: "#fff",
        pointHighlightStroke: "rgba(101, 133, 187,1)",
        data: sw1
    };

    if (_sel == '' || _sel.indexOf("t") >= 0)
    	ds.push(_t);


    _s = {
        label: "Purchase Total",
        fillColor: "rgba(155, 101, 187,0.5)",
...
function memberData() {
    ...
    var data = {
        ...
        datasets: [
            {
                label: "This Week",
                fillColor: "rgba(101, 133, 187,0.2)",
                strokeColor: "rgba(101, 133, 187,1)",
                pointColor: "rgba(101, 133, 187,1)",
                pointStrokeColor: "#fff",
                pointHighlightFill: "#fff",
