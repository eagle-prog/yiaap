    ...
    <div class="flex-fill">
        <div class="bg-base-0 position-relative pt-5 pt-sm-6">
            ...
            <div class="container position-relative z-1">
                <div class="row">
                    <div class="col-12 pt-sm-5 text-center text-break">
                        <h1 class="display-4 font-weight-bold">
                            {{ __('Privacy focused, web analytics.') }}
                        </h1>
                        <h2 class="text-muted font-weight-normal mt-4 font-size-xl text-center">{{ __('Realtime web analytics with privacy and simplicity at its core.') }}</h2>
                    </div>
                </div>
            </div>

            <div class="d-flex justify-content-center flex-wrap container position-relative mt-4 mb-5 text-center z-1">
                <a href="{{ route('register') }}" class="btn btn-primary btn-lg font-size-lg my-2 d-inline-flex align-items-center mx-2">{{ __('Get started') }}</a>
            ...
            <div class="container position-relative mt-3 z-1">
                <div class="row d-flex justify-content-center">
                    <div class="col-12 col-lg-10">
                        <img src="{{ asset('images/hero.png') }}" class="img-fluid rounded-lg shadow-lg">
                    </div>
                </div>
            </div>
            ...
            <div class="container pb-5 pb-md-7">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        <div class="row mt-4 font-weight-bold font-size-lg">
                            ...
                            <div class="col-12 col-lg-4 mt-5">
                                <div>{{ __('Yours.') }} <span class="text-muted">{{ __('All your data belongs to you, 100%.') }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-base-1">
            <div class="container py-5 py-md-7 position-relative z-1">
                ...
                <div class="m-auto text-center">
                    <p class="text-muted font-weight-normal font-size-lg">{{ __('Get to know your visitors with our advanced analytics.') }}</p>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4">
                        <div class="row mx-lg-n4">
                            ...
                            @foreach($features as $feature)
                                <div class="col-12 pr-md-3 pl-md-3 pr-lg-4 pl-lg-4 mt-5 feature">
                                    <div class="d-flex">
                    ...
                    <div class="col-12 col-lg-4 mt-5">
                                    ...
                                    <div class="list-group-item px-0 border-0">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="progress chart-progress w-100">
                                                <div class="progress-bar bg-visitor rounded" role="progressbar" style="width: 37%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card border-0 shadow stat-card cursor-default">
                            <div class="card-body">
                                <div class="list-group list-group-flush my-n3">
                                    <div class="list-group-item px-0 border-0">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="progress chart-progress w-100">
                                                <div class="progress-bar bg-visitor rounded" role="progressbar" style="width: 76%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="list-group list-group-flush my-n3">
                                    <div class="list-group-item px-0 border-0">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="progress chart-progress w-100">
                                                <div class="progress-bar bg-visitor rounded" role="progressbar" style="width: 11%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="list-group list-group-flush my-n3">
                                    <div class="list-group-item px-0 border-0">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="progress chart-progress w-100">
                                                <div class="progress-bar bg-visitor rounded" role="progressbar" style="width: 10%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="list-group list-group-flush my-n3">
                                    <div class="list-group-item px-0 border-0">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="progress chart-progress w-100">
                                                <div class="progress-bar bg-visitor rounded" role="progressbar" style="width: 86%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="list-group list-group-flush my-n3">
                                    <div class="list-group-item px-0 border-0">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="progress chart-progress w-100">
                                                <div class="progress-bar bg-visitor rounded" role="progressbar" style="width: 74%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="list-group list-group-flush my-n3">
                                    <div class="list-group-item px-0 border-0">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="progress chart-progress w-100">
                                                <div class="progress-bar bg-visitor rounded" role="progressbar" style="width: 60%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="bg-base-0">
            <div class="container position-relative text-center py-5 py-md-7 d-flex flex-column z-1">
                ...
                <div class="m-auto text-center">
                    <p class="text-muted font-weight-normal font-size-lg">{{ __('Easily integrates with your favorite platforms.') }}</p>
                </div>
        ...
        @if(config('settings.stripe'))
            <div class="bg-base-1">
                <div class="container py-5 py-md-7 position-relative z-1">
                    ...
                    <div class="m-auto text-center">
                        <p class="text-muted font-weight-normal font-size-lg">{{ __('Simple, traffic-based pricing.') }}
                    </div>
