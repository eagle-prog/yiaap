                                    ...
                                    <div class="list-group-item px-0 text-muted">
                                        <div class="row d-flex align-items-center">
                                            ...
                                            <div class="col-auto d-flex align-items-center">
                                                ...
                                                <a href="#" class="btn btn-sm text-primary d-flex align-items-center invisible {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@include('icons.horizontal_menu', ['class' => 'fill-current width-4 height-4'])&#8203;</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="list-group-item px-0">
                                            <div class="row d-flex align-items-center">
                                                ...
                                                <div class="col-auto d-flex align-items-center">
                                                    ...
                                                    <a href="#" class="btn btn-sm text-primary d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'mr-3' : 'ml-3') }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@include('icons.horizontal_menu', ['class' => 'fill-current width-4 height-4'])&#8203;</a>
...
@include('shared.modals.delete_website')
@endsection
