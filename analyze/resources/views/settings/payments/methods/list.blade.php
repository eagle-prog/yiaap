                        ...
                        <div class="row align-items-center">
                            <div class="col text-truncate">
                                <div class="row text-truncate">
                                    <div class="col-12 col-lg-6 d-inline-flex align-items-center text-truncate">@include('icons.payments.' . (in_array($payment->card->brand, config('payments')) ? $payment->card->brand : 'unknown'), ['class' => 'flex-shrink-0 width-6']) <span class="mx-2"><span class="d-none d-sm-inline-flex">••••</span> {{ $payment->card->last4 }}</span> @if($defaultPaymentMethod && $defaultPaymentMethod->id == $payment->id) <span class="badge badge-secondary text-truncate">{{ __('Default') }}</span>@endif</div>
