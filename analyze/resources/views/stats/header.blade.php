<div class="bg-base-1 pt-3">
    <div class="container pt-3">
        ...
        <div class="d-flex align-items-end">
            <h2 class="mb-0 flex-grow-1 text-truncate">{{ $website->url }}</h2>

            <div class="d-flex align-items-center flex-grow-0">
                <div class="form-row flex-nowrap">
                    <div class="col">
                        <a href="#" class="btn text-secondary d-flex align-items-center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@include('icons.horizontal_menu', ['class' => 'fill-current width-4 height-4'])&#8203;</a>
                    ...
                    <div class="col">
                        ...
                        <form method="GET" name="date-range" action="{{ route(Route::currentRouteName(), ['id' => $website->url]) }}">
