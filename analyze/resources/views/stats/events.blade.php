                ...
                <div class="col-12 col-md-auto">
                    <div class="form-row">
                        ...
                        @if(Auth::check() && $website->user_id == Auth::user()->id)
                            <div class="col-auto">
                                <a href="#" class="btn btn-sm btn-outline-primary d-flex align-items-center" data-toggle="modal" data-target="#eventModal" data-enable="tooltip" title="{{ __('Event code') }}">@include('icons.brackets', ['class' => 'fill-current width-4 height-4'])&#8203;</a>
                            </div>
                        @endif
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border-0 shadow">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">{{ __('Event code') }}</h6>
