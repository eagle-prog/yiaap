...
<tr>
<td style="text-align: {{ (__('lang_dir') == 'rtl' ? 'right' : 'left') }}; width: 40%; color: #262626;"><a href="{{ route('stats.overview', ['id' => $website['url'], 'from' => $range['from'], 'to' => $range['to']]) }}">{{ $website['url'] }}</a></td>
<td style="text-align: {{ (__('lang_dir') == 'rtl' ? 'left' : 'right') }}; width: 30%; color: #007BFF">{{ number_format($website['visitors'], 0, __('.'), __(',')) }}</td>
