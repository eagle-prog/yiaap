                        ...
                        <div class="row align-items-center">
                            <div class="col text-truncate">
                                <div class="row text-truncate">
                                    <div class="col-12 col-lg-5 text-truncate"><a href="{{ route('admin.subscriptions.edit', $subscription->id) }}">{{ $subscription->name }}</a></div>

                                    <div class="col-12 col-lg-5 d-flex align-items-center text-truncate">
                                        <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                            <img src="{{ gravatar($subscription->user->email, 48) }}" class="rounded-circle width-6 height-6">
                                        </div>
                                        <a href="{{ route('admin.users.edit', $subscription->user->id) }}" class="text-truncate">{{ $subscription->user->name }}</a>
                                    </div>
