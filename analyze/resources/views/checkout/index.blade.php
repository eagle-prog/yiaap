                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="input-group flex-nowrap">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="addon-wrapping"><div class="d-flex align-items-center">@include('icons.payments.' . (in_array($paymentMethod->card->brand, config('payments')) ? $paymentMethod->card->brand : 'unknown'), ['class' => 'width-6'])</div></span>
                                    </div>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                @if($plan->coupons && !$coupon)
                                    <li class="list-group-item">
                                        ...
                                        <div class="form-row {{ $errors->has('coupon') ? '' : 'd-none' }}" id="coupon-input">
                                            <div class="col">
                                                <div class="form-group mb-0">
