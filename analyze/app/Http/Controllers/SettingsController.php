...
class SettingsController extends Controller
{
    ...
    public function createPaymentMethod(Request $request)
    {
        ...
        // Prevents the user from adding a new payment information before going through the checkout process
    ...
    public function updateBilling(UpdateBillingRequest $request)
    {
        ...
        // Prevents the user from adding billing information before going through the checkout process
        if ($user->card_brand == null) {
            return redirect()->back();
        }
