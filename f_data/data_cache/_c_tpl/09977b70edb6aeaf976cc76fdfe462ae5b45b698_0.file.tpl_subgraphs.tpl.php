...
/* Smarty version 3.1.33, created on 2021-02-06 12:21:35
  from '/home/yiaapc5/public_html/f_templates/tpl_backend/tpl_subscriber/tpl_subgraphs.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_601ed01f0d2f41_10473996',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '09977b70edb6aeaf976cc76fdfe462ae5b45b698' => 
    array (
      0 => '/home/yiaapc5/public_html/f_templates/tpl_backend/tpl_subscriber/tpl_subgraphs.tpl',
      1 => 1554339360,
      2 => 'file',
    ),
  ),
...
function content_601ed01f0d2f41_10473996 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('ff', $_prefixVariable1);?>
            	<div class="vs-column sixths">
                    <div class="rev_earned files_holder">
                        <div class="counter_title"><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.earned"),$_smarty_tpl);?>
</div>
                        ...
                        <div class="status active-status"><?php echo smarty_function_lang_entry(array('key'=>"subnav.entry.sub"),$_smarty_tpl);?>
</div>
                        <div class="small-inactive-timer small-inactive-timer-rev"><?php echo $_smarty_tpl->tpl_vars['twsubscribers']->value;?>
</div>
                        <div class="status inactive-status"><?php echo smarty_function_lang_entry(array('key'=>"frontend.global.subscribers.cap"),$_smarty_tpl);?>
</div>
            	...
            	<div class="vs-column sixths">
                    <div class="rev_shared files_holder">
                        <div class="counter_title"><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.shared"),$_smarty_tpl);?>
</div>
            	...
            	<div class="vs-column sixths">
                    <div class="rev_total files_holder">
                        <div class="counter_title"><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.total"),$_smarty_tpl);?>
</div>
...
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.head.month.nr"),$_smarty_tpl);
...
if ($_GET['w'] > 0) {
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.head.week.nr"),$_smarty_tpl);
echo smarty_modifier_sanitize($_GET['w']);
} else {
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.head1.".((string)$_smarty_tpl->tpl_vars['ff']->value)),$_smarty_tpl);
}
}
}?></h1>
                            ...
                            <div class="filter-wrap">
                                <input type="checkbox" name="this_week_filter" value="e" class="this-week-filter" checked="checked"><label><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.earned"),$_smarty_tpl);?>
</label>
                                <input type="checkbox" name="this_week_filter" value="s" class="this-week-filter" checked="checked"><label><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.shared"),$_smarty_tpl);?>
</label>
                                <input type="checkbox" name="this_week_filter" value="t" class="this-week-filter" checked="checked"><label><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.total"),$_smarty_tpl);?>
</label>
...
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.head2.".((string)$_smarty_tpl->tpl_vars['ff']->value)),$_smarty_tpl);
}
}
}?></h1>
                            <div class="filters-loading">Loading filters...</div>
                            ...
                            <div class="vs-column full">
                            <div class="filter-wrap">
                                <input type="checkbox" name="last_week_filter" value="e" class="last-week-filter" checked="checked"><label><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.earned"),$_smarty_tpl);?>
</i></label>
                                <input type="checkbox" name="last_week_filter" value="s" class="last-week-filter" checked="checked"><label><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.shared"),$_smarty_tpl);?>
</label>
                                <input type="checkbox" name="last_week_filter" value="t" class="last-week-filter" checked="checked"><label><?php echo smarty_function_lang_entry(array('key'=>"backend.sub.label.total"),$_smarty_tpl);?>
</label>
                ...
                <div class="vs-column half">
                    <div class="block">
                        <header class="Titles">
                            <h1 class="Titles-main"><i class="icon-users"></i> <?php if ($_GET['y'] > 0) {
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.subs.month.nr"),$_smarty_tpl);
echo smarty_modifier_sanitize($_GET['y']);
} else {
if ($_GET['m'] > 0) {
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.subs.month.nr"),$_smarty_tpl);
...
if ($_GET['w'] > 0) {
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.subs.week.nr"),$_smarty_tpl);
echo smarty_modifier_sanitize($_GET['w']);
} else {
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.head3.".((string)$_smarty_tpl->tpl_vars['ff']->value)),$_smarty_tpl);
}
}
}?></h1>
                        </header>
...
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.head4.".((string)$_smarty_tpl->tpl_vars['ff']->value)),$_smarty_tpl);
}
}
}?></h1>
                        </header>
...
echo $_smarty_tpl->tpl_vars['mn']->value[$_prefixVariable6];
} else {
if ($_GET['w'] > 0) {
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.head.week.nr"),$_smarty_tpl);
echo smarty_modifier_sanitize($_GET['w']);
...
echo $_smarty_tpl->tpl_vars['mn']->value[$_prefixVariable7];
} else {
if ($_GET['w'] > 0) {
echo smarty_function_lang_entry(array('key'=>"backend.sub.dash.head.week.nr"),$_smarty_tpl);
echo smarty_modifier_sanitize($_GET['w']-1);
