...
function e(str) {
    ...
    var _cc = document.getElementById('_close');
    _cc.style.position = 'absolute';
    _cc.style.top = '10px';
    _cc.style.right = '10px';
    _cc.style.color = '#000';
    _cc.style.fontSize = '12px';
    _cc.style.fontWeight = 'bold';
    _cc.style.cursor = 'pointer';
    _cc.innerHTML = 'close x';
    _cc.onclick = function(){
