...
<body <?=($preloader_show == '1' ? 'class="overflow '.($dir_rtl == '1' ? 'rtl_support':'').'"':($dir_rtl == '1' ? 'class="rtl_support"':''));?>>
	...
	<div class="site">
		...
		<div class="main">
			...
			if(current_page() == 'create_contest') {
				include('create_contest.php');
			}
			...
			if(current_page() == 'my_contests') {
				include('my_contests.php');
			}
