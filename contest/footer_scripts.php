	...
	var lang_rule = '<?=_LANG_RULE;?>';
	var lang_prize_name = '<?=_LANG_PRIZE_NAME;?>';
	var lang_prize_desc = '<?=_LANG_PRIZE_DESC;?>';
	var is_loading = 1;
	...
	var email_confirm = '<?=(isset($settings['confirm_mail']) && $settings['confirm_mail'] == '1' ? '1' : '0');?>';
	var new_contest_price = '<?=(isset($settings['user_contest_price']) ? $settings['user_contest_price'] : '0');?>';
	var review_uploader = '<?=(isset($settings['uploader']) && $settings['uploader'] == '1' ? '1':'0');?>';
	var razorpay_api = '<?=(isset($settings['razorpay_api']) && $settings['razorpay_api'] ? $settings['razorpay_api'] : '');?>';
	</script>

	<script type="text/javascript" src="_js/functions.js?v=1.7.0"></script>
